        ...
        <table className="w-full">
          <thead className="bg-gray-50 text-xs uppercase text-gray-500">
            <tr>
              ...
              <th className="px-6 py-3 text-left font-medium">Mark</th>
              <th className="px-6 py-3 text-left font-medium">Model</th>
              <th className="px-6 py-3 text-left font-medium">VIN No</th>
              <th className="px-6 py-3 text-left font-medium">Production Year</th>
